            ...
            <div className='d-flex'>
              ...
              <div className='col-md-8 mt-3 text-end'>
                <Tooltip title={`${students} Enrolled`}>
                  <UserSwitchOutlined className='h5 pointer text-info mr-4' style={{cursor: "pointer"}} />
                </Tooltip>
                ...
                {course.lessons && course.lessons.length < 5 ? (
                  <Tooltip title='Min 5 lessons required to publish'>
                    <QuestionCircleFilled className='h5 pe-auto text-danger' />
                  </Tooltip>
                ) : course.published ? (
                  <>
                    ...
                    <Tooltip title='>Click to Unpublish now' color={"gold"}>
                      <EyeInvisibleFilled
                        onClick={handleUnpublish}
                        className='h5 pe-auto text-danger'
                      />
                    </Tooltip>
                  </>
                ) : (
                  <>
                    <Tooltip title='>Click to Publish now' color={"green"}>
                      <EyeFilled
                        onClick={handlePublish}
                        className='h5 pe-auto text-success'
                      />
                    </Tooltip>
